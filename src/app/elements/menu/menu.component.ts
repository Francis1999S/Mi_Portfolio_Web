...
menu():void {
  ...
  if (menu && bar1 && bar2 && bar3 && li1 && li2 && li3 && li4 && ThreeD_menu && pop1 && pop2 && pop3 && pop4) {
    if (this.flag) {
      pop1.style.top = '-55px';
      pop2.style.top = '-55px';
      pop3.style.top = '-55px';
      ...
      setTimeout(function(){if (li1 && li2 && li3 && li4 && menu) {
      ...
      setTimeout(function(){
        ...
        pop1.style.top = '67px';
        pop2.style.top = '155px';
        pop3.style.top = '240px';
        pop4.style.top = '327px';
    }},100);
      ThreeD_menu.style.transform = 'rotateY(0deg)';
      setTimeout(function(){if (li1 && li2 && li3 && li4) {
